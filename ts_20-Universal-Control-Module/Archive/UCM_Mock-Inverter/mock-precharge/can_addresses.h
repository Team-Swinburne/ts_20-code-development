asz// TEAM SWINBURNE - TS STANDARD CANBUS DESIGN RULES
...
#define CAN_UCM_BASE_ADDRESS                        0x620       // Note that for each UCM, there will be multiple addresses 0x510, 0x520,... etc.      
...
#define CAN_INV_ACTUAL_VALUE1                       0x221
#define CAN_INV_ACTUAL_VALUE2                       0x222

#define CAN_INV1_ACTUAL_VALUE1                       0x241
#define CAN_INV1_ACTUAL_VALUE2                       0x242
...
#define INTERVAL_DRIVER_RECTION                 10
